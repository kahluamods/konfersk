...
L["  Resume normal %s operations."] = "  Reprendre les activit�s normales de %s."
...
L["%s: new bid received. Number of bidders: %d."] = "%s : nouvelle ench\195\168re re�ue. Nombre d'ench\195\169risseurs : %d."
...
L["Randomly Add to Existing Members"] = "Ajouter al�atoirement"
